...
<h3 class='databasename'>Database: {$this->db}</h3>
	<div id='{$id}'>
		...
		<div>
			...
			<button><a class='nolink' href='./generate/interface/{$this->db}'>Generate CRUD Interface</a></button><br>
			...
			<button><a class='nolink' href='./generate/classes/{$this->db}'>Generate All Classes</a></button>
			...
			<button><a class='nolink' href='./generate/plugins/{$this->db}'>Generate All Plugins</a></button>
			</ul>
